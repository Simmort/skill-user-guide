...
1. 查看头条热榜，选择事实信息相对完整、具有讨论空间且适合账号定位的话题。
...
这一步本 Skill 会尝试根据输入素材进行话题背景检索，生成信息摘要，提取出可以用到的观点、写作元素
...
- 是否有明确切入点？
- 观点是否鲜明？
- 开头是否能够制造信息缺口，保留阅读动力，但不得隐瞒关键事实或制造无法兑现的悬念？
- 是否存在夸大或未经证实的说法？
- 是否符合账号平时的表达风格、字数要求？
